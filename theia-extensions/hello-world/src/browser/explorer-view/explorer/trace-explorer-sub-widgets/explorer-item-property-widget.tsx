...
import { Signals, signalManager } from '../../util/signal-manager';

@injectable()
export class ExplorerPropertyWidget extends ReactWidget {
  ...
  @postConstruct()
  init(): void {
    this.id = ExplorerPropertyWidget.ID;
    this.title.label = ExplorerPropertyWidget.LABEL;
