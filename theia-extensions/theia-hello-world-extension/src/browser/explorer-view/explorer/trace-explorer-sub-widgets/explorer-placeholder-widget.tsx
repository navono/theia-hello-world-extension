...
@injectable()
export class ExplorerPlaceholderWidget extends ReactWidget {
  ...
  init(): void {
    ...
    this.id = ExplorerPlaceholderWidget.ID;
    this.title.label = ExplorerPlaceholderWidget.LABEL;
    this.update();
  }
  ...
  render(): React.ReactNode {
    ...
    return (
      <div className="theia-navigator-container" tabIndex={0}>
